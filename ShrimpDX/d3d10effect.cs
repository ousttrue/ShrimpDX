...
namespace ShrimpDX {
    ...
    public class ID3D10EffectConstantBuffer: ID3D10EffectVariable
    {
        ...
        public HRESULT SetConstantBuffer(
            ...
            return  callback(Self, pConstantBuffer);
        }
        
        delegate HRESULT SetConstantBufferFunc(IntPtr self, ID3D10Buffer pConstantBuffer);
        ...
        public HRESULT SetTextureBuffer(
            ...
            return  callback(Self, pTextureBuffer);
        }
        
        delegate HRESULT SetTextureBufferFunc(IntPtr self, ID3D10ShaderResourceView pTextureBuffer);
    ...
    public class ID3D10EffectShaderResourceVariable: ID3D10EffectVariable
    {
        ...
        delegate HRESULT SetResourceFunc(IntPtr self, ID3D10ShaderResourceView pResource);
    ...
    public class ID3D10EffectRenderTargetViewVariable: ID3D10EffectVariable
    {
        ...
        delegate HRESULT SetRenderTargetFunc(IntPtr self, ID3D10RenderTargetView pResource);
    ...
    public class ID3D10EffectDepthStencilViewVariable: ID3D10EffectVariable
    {
        ...
        delegate HRESULT SetDepthStencilFunc(IntPtr self, ID3D10DepthStencilView pResource);
